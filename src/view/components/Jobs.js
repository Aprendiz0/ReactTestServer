...
import { toggleDay } from '../reduxStore/actions'
...
class Jobs extends React.Component {
    ...
    render() {
        return (
            <>
                <a className="waves-effect btn-small principalBackgroundColor"><i className="material-icons left">add</i>Novo Grupo</a>
                <hr />
...
export default connect(
    mapStateToProps,
    Utils.bindMapDispatchToProps({ toggleDay })
)(Jobs);